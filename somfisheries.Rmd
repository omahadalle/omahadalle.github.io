...
Introduction
Somalia is located in a highly productive upwelling area. Somali fishers use traditional fishing methods to catch coastal large pelagic fishes. Domestic fishey sector is poorly managed due to lack of effective fisheries policy. Indeed, the fisheries regulations are so outdated.  
Foreign Fishing
...
develop quotas for HMS based on the total allowable catch (TAC).
provides scientific information and management recommendations for stocks of yellowfin tuna
